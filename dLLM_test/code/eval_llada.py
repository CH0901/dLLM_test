    ...
    def __init__(
        ...
        **kwargs,
        ...
        if quant_ckpt is not None:
            ...
            print(f"[DuQuant] loading {quant_ckpt}")
            params = _torch.load(quant_ckpt, map_location='cpu')
            self.model = apply_duquant_to_model(self.model, params, device=str(self.device))
            print("[DuQuant] applied ✓")
